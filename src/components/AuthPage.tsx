        ...
        <div className="glass-card p-8 glow-primary">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-primary text-primary-foreground rounded-lg font-medium text-sm flex items-center justify-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-50 shadow-lg shadow-primary/20"
            >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-secondary px-2 text-muted-foreground font-medium">Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-secondary border border-border text-foreground rounded-lg font-medium text-sm flex items-center justify-center gap-3 hover:bg-sidebar-accent/50 transition-all group"
          >
